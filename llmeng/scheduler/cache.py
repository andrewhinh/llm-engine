...
from llmeng.core import Req
from llmeng.kvcache import BaseCacheHandle, MatchResult, create_prefix_cache
from llmeng.utils import div_ceil
...
class CacheManager:
    ...
    def cache_req(self, req: Req, *, finished: bool) -> None:
        ...
        self._free(page_indices[old_handle.cached_len : cached_len])  # type: ignore[misc]
        if finished:  # this tail part should be freed
            self._free(page_indices[new_handle.cached_len :])  # type: ignore[misc]
