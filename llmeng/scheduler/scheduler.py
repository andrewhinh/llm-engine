...
import torch
from llmeng.core import Batch, Req
...
from llmeng.utils import init_logger, load_tokenizer
...
if TYPE_CHECKING:
    from llmeng.engine import BatchSamplingArgs, ForwardOutput
...
class Scheduler(SchedulerIOMixin):
    def __init__(self, config: SchedulerConfig):
        from llmeng.engine import Engine
    ...
    def _forward(self, forward_input: ForwardInput) -> ForwardOutput:
        ...
        if (
            ENV.OVERLAP_EXTRA_SYNC
        ):  # NOTE: https://github.com/sgl-project/mini-sglang/issues/58
